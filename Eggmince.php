...
<body>
   ...
   <section class="colored-section" id="recipes">
    ...
    <h2 class="recipe">How to make an EggMince Special Dish!</h2>
    ...
    <div class="container-fluid-recipes">
        <div class="row">
            <div class="pizza-recipe col-lg-12">
                <h1 class="actual-recipe-heading">EggMince</h1>
                <p class="actual-recipe-paragraphs">
                    EggMince is an amazing and unique dish. It will only take 30 minutes to cook. 
                  Serve hot with any drink. 
                </p>

                <div><img class="recipe-images" src="images/mince2.jpg" alt="EggMince"></div>
                ...
                <p class="actual-recipe-paragraphs">
                    ...
                    <div><img class="recipe-images" src="images/mince.jpg" alt=""></div>
                <p class="actual-recipe-paragraphs">
                    6. Take it out and serve hot with a drink 😊😋😋 Enjoy with family and friends for either lunch or dupper. 
                </p>

                <div><img class="recipe-images" src="images/mince3.jpg" alt=""></div>
            </div>
        </div>
    </div>
  </section>
